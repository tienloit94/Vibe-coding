...
interface GroupStore {
  ...
  createGroup: (data: { name: string; description?: string; members: string[] }) => Promise<Group>;
  ...
  sendGroupMessage: (groupId: string, content: string, messageType?: 'text' | 'file', fileUrl?: string, fileName?: string) => Promise<void>;
...
export const useGroupStore = create<GroupStore>((set, get) => ({
  ...
  sendGroupMessage: async (groupId, content, messageType = 'text', fileUrl, fileName) => {
    try {
      const response = await axios.post(
