...
import { LogOut, Search, MessageSquare, Users as UsersIcon } from 'lucide-react';
              ...
              filteredUsers.map((chatUser) => {
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      <Avatar>
                        <AvatarImage src={chatUser.avatar ? `http://localhost:5000${chatUser.avatar}` : undefined} alt={chatUser.name} />
                        <AvatarFallback>
                    ...
                    <div className="flex-1 text-left">
                      <p className="font-medium dark:text-white">{chatUser.name}</p>
