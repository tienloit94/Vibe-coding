...
export default function ChatArea() {
  ...
  const { blockUser, unblockUser, isBlocked, fetchBlockedUsers } =
    useBlockStore();
  ...
  useEffect(() => {
    socketService.on(
      "call-made",
      (data: { from: string; callerName: string; signal: any }) => {
  ...
  const handleScroll = () => {
    ...
    if (!container || !selectedUser || !hasMoreMessages || loadingMessages)
      return;
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="flex items-center justify-between space-x-3 border-b dark:border-gray-700 bg-white dark:bg-gray-800 p-4">
        <div
          className="flex items-center space-x-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 rounded p-2 -ml-2"
        ...
        >
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button
                            ...
                            } top-1 opacity-0 group-hover:opacity-100 transition-opacity h-6 w-6 p-0`}
                          >
          ...
          {isTyping && (
            <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <span>
                {typingUser || selectedUser?.name || "Someone"} is typing...
              </span>
            </div>
          )}
